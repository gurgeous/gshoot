...
func TestBrandRenderMatchesColorProfile(t *testing.T) {
	...
	truecolor := style(colorprofile.TrueColor, c, true).Render("brand")
	ansi256 := style(colorprofile.ANSI256, c, true).Render("brand")
	noColor := style(colorprofile.NoTTY, c, true).Render("brand")
